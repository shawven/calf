...
public class HttpClientUtils {
    ...
    private static PoolingHttpClientConnectionManager defaultConnectionManager;
    ...
    static {
        try {
            ...
            defaultSSLConnectionSocketFactory = new SSLConnectionSocketFactory(sslcontext,
            ...
            defaultConnectionManager = new PoolingHttpClientConnectionManager(registry);
            defaultConnectionManager.setMaxTotal(MAX_TOTAL);
            defaultConnectionManager.setDefaultMaxPerRoute(MAX_PER_ROUTE);
    ...
    public static CloseableHttpClient getDefaultClient() {
        return getClient(defaultRequestConfig, defaultConnectionManager,
    ...
    private static boolean invalidPair(String key, Object value) {
    ...
    public static class HttpClientExecutor {
        ...
        private String doExecute() throws IOException {
            ...
            CloseableHttpClient client = getClient(requestConfigBuilder.build(), defaultConnectionManager,
                    defaultSSLConnectionSocketFactory);
