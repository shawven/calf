package com.test.app.support.util.pdf;
...
public class PdfUtil {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String template =  table.getNumberOfRows() > 4 ? "F:/defaultServiceContract2.com.test.support.util.pdf" : "F:/defaultServiceContract1.com.test.support.util.pdf";
        PdfUtil pdfUtil = new PdfUtil(template, "f:/newDefaultServiceContract.com.test.support.util.pdf");
        TableBlock tableBlock = pdfUtil.new TableBlock(table);
        // 宽度100%
        tableBlock.setWidth(100);

        Document document = pdfUtil.getDocument();
        PdfUtil.Position position = pdfUtil.getPositionByText("本次为您所提供的服务如下");
