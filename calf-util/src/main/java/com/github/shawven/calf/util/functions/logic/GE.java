 ...
 * @date 2023/12/5
 */
public class GE extends BaseFunction {
    ...
    public FunctionDoc doc() {
        return FunctionDoc.builder()
                .desc("GE函数用于比较两个数的大小，value1大于等于value2返回true")
                .usage("GE(value1,value2)，等价于 value1 >= value2")
                .example("示例: GE(年龄，30) 年龄大于等于30的返回true");
    }
}
