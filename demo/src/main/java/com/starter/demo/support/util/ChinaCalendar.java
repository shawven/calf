...
//            "1226  **诞辰"
    ...
    public static Element getCalendar(LocalDate localDate) {
        return getCalendar(YearMonth.from(localDate)).get(localDate.getDayOfMonth() - 1);
    }

    public static List<Element> getCalendar(YearMonth yearMonth) {
        ChinaCalendar lunarCalendarUtil = new ChinaCalendar();
        try {
            lunarCalendarUtil.calendar(yearMonth.getYear(), yearMonth.getMonthValue() - 1);
    ...
    public void calendar(int y, int m) throws ParseException {
        ...
        // 清明
        if (m == 3) {
            elements.get(tmp1).color = "red";
            elements.get(tmp1).lunarFestival =  elements.get(tmp1).solarTerms;
        }
        ...
        for (String i : sFtv) {
            ...
            if (matcher.matches()) {
                ...
                if (Integer.valueOf(matcher.group(1)).intValue() == (m + 1)) {
                    ...
                    if (matcher.group(3).equals("*")) elements.get(Integer.valueOf(matcher.group(1)) - 1).color = "red";
                }
            }
        }
...
//    }
    ...
    public static class Element {
        ...
        public LocalDate getLocalDate() {
            return LocalDate.of(sYear, sMonth, sDay);
        }
        ...
        public String toString() {
            ...
            sb.append(", lYear=").append(lYear);
            sb.append(", lMonth=").append(lMonth);
            sb.append(", lMonthChinese='").append(lMonthChinese).append('\'');
            sb.append(", lDayChinese='").append(lDayChinese).append('\'');
            sb.append(", lDay=").append(lDay);
            sb.append(", isLeap=").append(isLeap);
            sb.append(", cYear='").append(cYear).append('\'');
            sb.append(", cMonth='").append(cMonth).append('\'');
            sb.append(", cDay='").append(cDay).append('\'');
            ...
            sb.append(", solarTerms='").append(solarTerms).append('\'');
            sb.append(", sgz5='").append(sgz5).append('\'');
            sb.append(", sgz3=").append(sgz3);
            sb.append('}');
            return sb.toString();
        }
    }
    ...
    public static void main(String[] args) throws ParseException {
        System.out.println(ChinaCalendar.getCalendar(LocalDate.of(2021,2,11)));
        System.out.println(ChinaCalendar.getCalendar(LocalDate.of(2021,2,12)));
        System.out.println(ChinaCalendar.getCalendar(LocalDate.of(2020,10,1)));
        System.out.println(ChinaCalendar.getCalendar(LocalDate.of(2021,4,4)));
    }
}
