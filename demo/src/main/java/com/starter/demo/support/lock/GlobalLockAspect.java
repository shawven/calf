...
import com.starter.demo.support.constant.CacheName;
...
public class GlobalLockAspect {
    ...
    @Pointcut("@annotation(com.starter.demo.support.lock.GlobalLock) " +
            "|| @annotation(com.starter.demo.support.lock.GlobalTryLock)")
