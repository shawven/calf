...
public class PdfUtil {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String template =  table.getNumberOfRows() > 4 ? "F:/defaultServiceContract2.com.starter.support.util.pdf" : "F:/defaultServiceContract1.com.starter.support.util.pdf";
        PdfUtil pdfUtil = new PdfUtil(template, "f:/newDefaultServiceContract.com.starter.support.util.pdf");
