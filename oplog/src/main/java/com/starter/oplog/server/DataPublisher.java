package com.starter.oplog.server;

import com.starter.oplog.model.ClientInfo;
import com.starter.oplog.model.dto.*;
import com.starter.oplog.parm.LockLevel;
import com.starter.oplog.rabbit.DataPublisherRabbitMQ;
...
public class DataPublisher {
    ...
    public int deletePublishTopic(List<ClientInfo> clientInfos) {
        ...
        for(ClientInfo clientInfo : clientInfos) {
            ...
            rabbitPublisher.deleteTopic(topicName(clientInfo));
            if (deleteRes) {
                successCount++;
            }
        }
