...
package com.starter.payment.provider.unionpay.sdk;
...
public class UnionpayConstants {
    ...
    public static final String FRONT_TRANS_URL = "/gateway/api/frontTransReq.do";
    public static final String BACK_TRANS_URL = "/gateway/api/backTransReq.do";
    public static final String SINGLE_QUERY_URL = "/gateway/api/queryTrans.do";
    public static final String BATCH_TRANS_URL = "/gateway/api/batchTrans.do";
    public static final String FILE_TRANS_URL = "";
    public static final String APP_TRANS_URL = "/gateway/api/appTransReq.do";
    public static final String CARD_TRANS_URL = "/gateway/api/cardTransReq.do";

    // 以下缴费产品使用，其余产品用不到
    public static final String JF_FRONT_TRANS_URL = "/jiaofei/api/frontTransReq.do";
    public static final String JF_BACK_TRANS_URL = "/jiaofei/api/backTransReq.do";
    public static final String JF_SINGLE_QUERY_URL = "/jiaofei/api/queryTrans.do";
    public static final String JF_CARD_TRANS_URL = "/jiaofei/api/cardTransReq.do";
    public static final String JF_APP_TRANS_URL = "/jiaofei/api/appTransReq.do";
     ...
     * 风控信息域 .
     */
    public static final String param_riskRateInfo = "riskRateInfo";
    /**
     * 后台通知地址.
     */
