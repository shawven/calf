package com.test.payment.provider.alipay;
...
import com.test.payment.provider.alipay.sdk.AlipayConstants;
...
import static com.test.payment.provider.PaymentProviderEnum.ALIPAY;
