package com.test.payment.provider.unionpay;

import com.test.payment.domain.*;
import com.test.payment.properties.UnionpayProperties;
import com.test.payment.provider.AbstractPaymentTemplate;
import com.test.payment.provider.unionpay.sdk.UnionpayClient;
import com.test.payment.provider.unionpay.sdk.UnionpayConstants;
import com.test.payment.provider.unionpay.sdk.UnionpayException;
import com.test.payment.provider.unionpay.sdk.request.UnionpayTradePayRequest;
import com.test.payment.provider.unionpay.sdk.request.UnionpayTradeQueryRequest;
import com.test.payment.provider.unionpay.sdk.request.UnionpayTradeRefundQueryRequest;
import com.test.payment.provider.unionpay.sdk.request.UnionpayTradeRefundRequest;
