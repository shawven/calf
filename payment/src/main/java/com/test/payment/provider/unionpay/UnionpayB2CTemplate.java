...
import com.test.payment.provider.unionpay.sdk.request.UnionpayTradeReversalRequest;
import com.test.payment.provider.wechat.sdk.WXPayConstants;
...
import static com.test.payment.provider.PaymentProviderEnum.UNIONPAY;
