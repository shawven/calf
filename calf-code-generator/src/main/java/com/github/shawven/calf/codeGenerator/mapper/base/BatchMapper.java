package com.github.shawven.calf.codeGenerator.mapper.base;
...
import com.github.shawven.calf.codeGenerator.service.AopSupport;
...
public interface BatchMapper<T> extends AopSupport {
     ...
     * @return
     */
   boolean executeBatch(Consumer<SqlSession> consumer);
