...
export const getDatasourceNames = params=>{
  return axios.get(`${backendUrl}datasource/names`, {params: params});
};
...
export const persistDatasource = params => {
  return axios.post(`${backendUrl}datasource/save`, params);
}

export const updateDatasource = params => {
  return axios.post(`${backendUrl}datasource/update`, params);
}
