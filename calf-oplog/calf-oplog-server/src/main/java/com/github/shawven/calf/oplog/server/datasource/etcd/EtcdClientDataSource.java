...
public class EtcdClientDataSource implements ClientDataSource {
    ...
    public EtcdClientDataSource(Client client, KeyPrefixUtil keyPrefixUtil, NodeConfigDataSource nodeConfigDataSource) {
        this.client = client;
    ...
    @Override
    public boolean sendBinLogCommand(Command command) {
    ...
    private ByteSequence keyPrefix(String namespace, String key) {
        String finalKey = keyPrefixUtil.withPrefix(namespace) + Constants.PATH_SEPARATOR + key;
